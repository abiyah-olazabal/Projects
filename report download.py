...
import pandas as pd
filesheet = r"C:\Users\akolazabalc.CD-ROSAS\Documents\Cancelaciones\2024\Historial\Envios de ws 2024 - Marzo.xlsx"
...
if response.status_code == 200:
    ...
    if tabla:
        ...
        libro_excel.save(r'C:\Users\akolazabalc.CD-ROSAS\Documents\Cancelaciones\2024\informacion.xlsx')
        #'''
        #print(tabla)
else:
    print('Error')